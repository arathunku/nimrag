defmodule Nimrag.Api.Activity do
  ...
  def from_api_response(%{"distance" => distance, "duration" => duration, "beginTimestamp" => begin_timestamp, "startTimeLocal" => start_time} = _resp) do
    {:ok, %__MODULE__{
      duration: duration,
      distance: distance,
      begin_at: DateTime.from_unix!(begin_timestamp, :millisecond),
      start_local_at: NaiveDateTime.from_iso8601!(start_time)
    }}
  end
  ...
  #   "activityName" => "Wächtersbach Trail Running",
